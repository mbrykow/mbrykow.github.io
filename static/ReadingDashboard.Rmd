...
This is an example of a simple static dashboard I created in RMarkdown, using my downloaded reading data from  [Goodreads](https://www.goodreads.com). The purpose of this dashboard is to provide a sample of my coding skills as well as some code to view (or if you're particularly nosy, a glimpse into my reading habits too!). Last updated `r Sys.Date()`.

Currently reading:
![](Atmosphere.jpg){#id .class width=200 height=280px}
...
Books2026 <- books %>% 
  ...
  filter(year(Date.Read) == 2026)

NumBooks2026 <- Books2026 %>%
  count()
NumBooks2026 <- NumBooks2026$n
...
```{r}
NumPages2026 <- sum(Books2026$Number.of.Pages)
...
```{r}
AvgRate2026 <- Books2026 %>%
  summarise(AvgRating = mean(My.Rating))
AvgRate2026 <- AvgRate2026$AvgRating

valueBox(
  value = round(AvgRate2026,2),
  icon = "fa-star",
  color = Colors[3]
)
